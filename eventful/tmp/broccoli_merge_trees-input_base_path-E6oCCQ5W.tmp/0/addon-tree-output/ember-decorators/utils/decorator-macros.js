define('ember-decorators/utils/decorator-macros', ['exports', 'ember-decorators/utils/decorator-wrappers', 'ember-decorators/utils/extract-value', 'ember-decorators/utils/collapse-proto'], function (exports, _decoratorWrappers, _extractValue, _collapseProto) {
  'use strict';
  ...
  exports.decoratedConcatenatedProperty = decoratedConcatenatedProperty;
  ...
  function decoratedConcatenatedProperty(concatProperty) {
    return function (target, key, desc) {
      (0, _collapseProto.default)(target);

      if (!target.hasOwnProperty(concatProperty)) {
        var parentValue = target[concatProperty];
      ...
      desc.value = (0, _extractValue.default)(desc);
